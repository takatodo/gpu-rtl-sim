...
next_gpu_owned_state_construction_step:
  ...
  dmem_zero_fill_validation: strict_and_normalized_final_state_equivalence_pass
  dmem_zero_fill_validation_report: reports/xuantie_e902_dmem_zero_fill_validation.json
  dmem_zero_fill_dirty_bytes_validated: 262144
  dmem_zero_fill_boundary: packaged_deterministic_zero_fill_construction
  ...
  gpu_owned_state_construction_track_closure: closed_current_minimal_repo_scope
  closure_scope:
    - source_backed_iahb_case_pat_word_packed_program_image_initialization
    - deterministic_x_dmem_zero_fill_device_initialization
  ...
  closure_next_action: select_next_project_axis_after_gpu_owned_construction_closure
