...
| --- | --- | --- |
| Source-of-truth alignment | Inspect `README.md`, `config/selection.json`, `docs/status.md`, and `docs/roadmap.md`. | All point at `review_paged_attention_kv_cache_timing_summary` and `config/scaling_gates/paged_attention_kv_cache_timing_summary_gate.json`. |
