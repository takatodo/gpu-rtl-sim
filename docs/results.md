...
| --- | --- | --- |
| Source-of-truth alignment | Inspect `README.md`, `config/selection.json`, `docs/status.md`, and `docs/roadmap.md`. | All point at `define_public_results_packaging_refresh_after_paged_attention_kv_cache_timing_summary_gate` and `config/scaling_gates/paged_attention_kv_cache_timing_summary_review_gate.json`. |
