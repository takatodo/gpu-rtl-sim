...
Config-generation validation breadth execution and review are tracked by the current selection pointer and public-pack manifest. The public result narrative keeps the correctness policy and non-claims here, while detailed local candidate result/review records are not canonical unless they are tracked.
