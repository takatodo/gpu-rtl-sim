...
| --- | --- | --- |
| Source-of-truth alignment | Inspect `README.md`, `config/selection.json`, `docs/status.md`, and `docs/roadmap.md`. | All point at `run_paged_attention_kv_cache_scale_up_measurement_dry_run` and `config/scaling_gates/paged_attention_kv_cache_scale_up_measurement_gate.json`. |
