...
| --- | --- | --- |
| Source-of-truth alignment | Inspect `README.md`, `config/selection.json`, `docs/status.md`, and `docs/roadmap.md`. | All point at `run_paged_attention_kv_cache_repeat_median_timing_gate` and `config/scaling_gates/paged_attention_kv_cache_repeat_median_workflow_gate.json`. |
