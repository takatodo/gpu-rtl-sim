...
phase_3:
  ...
  implement_program_image_initialization_kernel_generation: next
  add_program_image_initialization_host_flag_and_env: pending
  upload_program_image_initialization_records_once: pending
