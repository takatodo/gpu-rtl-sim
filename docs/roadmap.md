...
Review the native Verilator option parser overlay patch compile-fix definition after the first build-only validation run.
...
- current next task: `review_verilator_native_option_parser_overlay_patch_compile_fix_gate`
