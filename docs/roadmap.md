...
4. **Docs pointer sync**: Keep `config/selection.json`, `docs/status.md`, this roadmap, README, and `for_codex/issues.md` aligned on `advance_stage124_source1029_after_sources976_1006_1020_diagnostic_atomic_suppression_cuda700`.
...
source1324/source976/source1006/source1020 diagnostic suppression. Stage124 has reached source1028
with source976/source1006/source1020 suppression and `transition_found=false`; the next
action is source1029 with source976/source1006/source1020 suppression carried forward.
