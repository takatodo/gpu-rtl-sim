...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_blanker.

module prim_blanker_gpu_cov_tb (
  ...
  logic in0_active_w;
  logic en_active_w;
  logic data_and_enable_active_w;

  logic [31:0] global_cycle_q;
  logic [31:0] traffic_cycle_q;
  logic [31:0] drain_cycle_q;
  logic [31:0] rand_q;
  logic [31:0] data_and_enable_active_count_q;
  logic [31:0] data_or_enable_inactive_count_q;
  ...
  assign expected_out_w = in1_i[0] ? in0_i : '0;
  assign next_expected_out_w = next_in1_w[0] ? next_in0_w : '0;
  assign observed_match_w = out_o == expected_out_w;
  assign next_observed_match_w = (next_in1_w[0] ? next_in0_w : '0) == next_expected_out_w;
  ...
  assign en_active_w = in1_i[0];
  assign data_and_enable_active_w = in0_active_w && en_active_w;
  ...
  always_ff @(posedge clk_i) begin
    ...
    if (!rst_ni) begin
      ...
      last_in0_q <= '0;
      last_in1_q <= '0;
      data_and_enable_active_count_q <= 32'd0;
      data_or_enable_inactive_count_q <= 32'd0;
      ...
      if (data_and_enable_active_w) begin
        data_and_enable_active_count_q <= data_and_enable_active_count_q + 32'd1;
        seen_q[2] <= 1'b1;
      end else begin
        data_or_enable_inactive_count_q <= data_or_enable_inactive_count_q + 32'd1;
  ...
  assign cfg_signature_o = cfg_seed_i ^ cfg_batch_length_i ^ cfg_reset_cycles_i ^
                           ...
                           32'ha2d2_0001;
  assign host_req_accepted_o = data_and_enable_active_count_q;
  assign device_req_accepted_o = data_or_enable_inactive_count_q;
  ...
  assign toggle_bitmap_word2_o = {
    data_and_enable_active_count_q[7:0],
    data_or_enable_inactive_count_q[7:0],
    nonzero_out_count_q[7:0],
    mismatch_count_q[7:0]
  };

  assign real_toggle_subset_word0_o = data_and_enable_active_count_q;
  assign real_toggle_subset_word1_o = data_or_enable_inactive_count_q;
  ...
  assign real_toggle_subset_word11_o = en_high_count_q;
  assign real_toggle_subset_word12_o = en_low_count_q;
  ...
  assign focused_wave_word1_o = {31'd0, in1_i[0]};
  assign focused_wave_word2_o = {24'd0, out_o};
  assign focused_wave_word3_o = {29'd0, output_any_w, observed_match_w,
                                 data_and_enable_active_w};
  assign focused_wave_word4_o = data_and_enable_active_count_q ^
                                data_or_enable_inactive_count_q;
  ...
  assign oracle_expected_ok_count_o = data_and_enable_active_count_q +
                                      data_or_enable_inactive_count_q -
                                      mismatch_count_q;
  ...
  assign oracle_semantic_case_seen_o = {23'd0, in0_i, in1_i[0]};
...
endmodule : prim_blanker_gpu_cov_tb
