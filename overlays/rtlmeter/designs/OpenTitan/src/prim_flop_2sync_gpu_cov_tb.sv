...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_flop_2sync.

module prim_flop_2sync_gpu_cov_tb (
  ...
  localparam logic [Width-1:0] ResetValue = 8'h5a;
...
endmodule : prim_flop_2sync_gpu_cov_tb
