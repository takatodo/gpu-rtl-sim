...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_flop_en.

module prim_flop_en_gpu_cov_tb (
  ...
  localparam logic [Width-1:0] ResetValue = 8'ha5;
  ...
  always_ff @(posedge clk_i) begin
    ...
    if (!rst_ni) begin
      ...
      drain_cycle_q <= 32'd0;
      rand_q <= cfg_seed_i ^ 32'h6eab_1e11;
      ...
      signature_q <= cfg_seed_i ^ 32'h1020_3040;
...
endmodule : prim_flop_en_gpu_cov_tb
