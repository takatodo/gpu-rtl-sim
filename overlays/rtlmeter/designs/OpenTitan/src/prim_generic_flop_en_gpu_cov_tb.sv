...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_generic_flop_en.

module prim_generic_flop_en_gpu_cov_tb (
...
endmodule : prim_generic_flop_en_gpu_cov_tb
