...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_lc_sender.

module prim_lc_sender_gpu_cov_tb (
  ...
  logic [LcTxWidth-1:0] expected_stage_q;
  logic [LcTxWidth-1:0] last_expected_stage_q;
  ...
  logic [31:0] sender_delay_seen_count_q;
  ...
  always_ff @(posedge clk_i) begin
    ...
    if (!rst_ni) begin
      ...
      drain_cycle_q <= 32'd0;
      rand_q <= cfg_seed_i ^ 32'h1c5e_5001;
      lc_raw_q <= ResetValue;
      last_lc_raw_q <= ResetValue;
      expected_stage_q <= ResetValue;
      last_expected_stage_q <= ResetValue;
      last_output_q <= ResetValue;
      ...
      sender_delay_seen_count_q <= 32'd0;
      branch_guard_count_q <= 32'd0;
      signature_q <= cfg_seed_i ^ 32'h1c5e_5eed;
      ...
      if (post_reset_seen_q && output_w == expected_stage_q) begin
  ...
  assign progress_signature_o = signature_q ^ {28'd0, lc_raw_q} ^ {28'd0, output_w};
  assign cfg_signature_o = progress_signature_o ^ cfg_seed_i ^ 32'h1c5e_5eed;
  ...
  assign real_toggle_subset_word8_o = sender_delay_seen_count_q;
  ...
  assign real_toggle_subset_word12_o = {20'd0, lc_raw_q, expected_stage_q, output_w};
  assign real_toggle_subset_word13_o = seen_q;
  assign real_toggle_subset_word14_o = {30'd0, done_o, rst_ni};
  assign real_toggle_subset_word15_o = output_change_count_q + output_follow_count_q;
  assign real_toggle_subset_word16_o = {24'd0, last_lc_raw_q, last_output_q};
  ...
  assign focused_wave_word2_o = {28'd0, output_w};
...
endmodule : prim_lc_sender_gpu_cov_tb
