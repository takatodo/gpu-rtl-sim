...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_mubi4_sync.

module prim_mubi4_sync_gpu_cov_tb (
  ...
  logic rst_ni;
  mubi4_t mubi_i;
  mubi4_t [NumCopies-1:0] mubi_o;
  logic [3:0] mubi_raw_q;
  logic [3:0] last_mubi_raw_q;
  logic [3:0] expected_stage1_q;
  logic [3:0] expected_stage2_q;
  logic [3:0] last_expected_stage2_q;
  logic [3:0] last_output0_q;
  logic [3:0] last_output1_q;
  logic [1:0] phase_w;
  ...
  always_ff @(posedge clk_i) begin
    ...
    if (!rst_ni) begin
      ...
      drain_cycle_q <= 32'd0;
      rand_q <= cfg_seed_i ^ 32'h4b1c_5001;
      mubi_raw_q <= MuBi4Width'(ResetValue);
      last_mubi_raw_q <= MuBi4Width'(ResetValue);
      expected_stage1_q <= MuBi4Width'(ResetValue);
      expected_stage2_q <= MuBi4Width'(ResetValue);
      last_expected_stage2_q <= MuBi4Width'(ResetValue);
      last_output0_q <= MuBi4Width'(ResetValue);
      last_output1_q <= MuBi4Width'(ResetValue);
      ...
      signature_q <= cfg_seed_i ^ 32'h4b1c_5eed;
      ...
      last_output0_q <= MuBi4Width'(mubi_o[0]);
      last_output1_q <= MuBi4Width'(mubi_o[1]);
      ...
      if (MuBi4Width'(mubi_o[0]) != last_output0_q) begin
        output0_change_count_q <= output0_change_count_q + 32'd1;
        seen_q[6] <= 1'b1;
      end
      if (MuBi4Width'(mubi_o[1]) != last_output1_q) begin
        output1_change_count_q <= output1_change_count_q + 32'd1;
        seen_q[7] <= 1'b1;
      end
      if (post_reset_seen_q && MuBi4Width'(mubi_o[0]) == expected_stage2_q &&
          MuBi4Width'(mubi_o[1]) == expected_stage2_q) begin
      ...
      if (MuBi4Width'(mubi_o[0]) != MuBi4Width'(mubi_o[1])) begin
        copy_mismatch_count_q <= copy_mismatch_count_q + 32'd1;
        seen_q[10] <= 1'b1;
      end
      if (MuBi4Width'(mubi_o[0]) == MuBi4Width'(ResetValue) &&
          MuBi4Width'(mubi_o[1]) == MuBi4Width'(ResetValue)) begin
      ...
      signature_q <= {signature_q[27:0], signature_q[31:28]} ^
                     {20'd0, mubi_raw_q, MuBi4Width'(mubi_o[0]), MuBi4Width'(mubi_o[1])} ^
  ...
  assign progress_signature_o = signature_q ^ {28'd0, mubi_raw_q} ^
                                {24'd0, MuBi4Width'(mubi_o[0]), MuBi4Width'(mubi_o[1])};
  assign cfg_signature_o = progress_signature_o ^ cfg_seed_i ^ 32'h4b1c_5eed;
  ...
  assign real_toggle_subset_word14_o = {20'd0, mubi_raw_q, expected_stage2_q,
                                        MuBi4Width'(mubi_o[0])};
  ...
  assign focused_wave_word2_o = {28'd0, MuBi4Width'(mubi_o[0])};
  assign focused_wave_word3_o = {28'd0, MuBi4Width'(mubi_o[1])};
  ...
  assign oracle_semantic_case_acked_o = {24'd0, MuBi4Width'(mubi_o[0]), MuBi4Width'(mubi_o[1])};
...
endmodule : prim_mubi4_sync_gpu_cov_tb
