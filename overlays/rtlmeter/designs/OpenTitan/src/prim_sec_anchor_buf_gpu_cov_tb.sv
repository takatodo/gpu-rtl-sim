...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_sec_anchor_buf.

module prim_sec_anchor_buf_gpu_cov_tb (
...
endmodule : prim_sec_anchor_buf_gpu_cov_tb
