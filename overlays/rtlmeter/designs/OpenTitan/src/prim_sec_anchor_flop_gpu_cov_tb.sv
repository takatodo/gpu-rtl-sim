...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_sec_anchor_flop.

module prim_sec_anchor_flop_gpu_cov_tb (
...
endmodule : prim_sec_anchor_flop_gpu_cov_tb
