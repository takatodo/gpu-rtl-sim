...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_secded_hamming_72_64_enc.

module prim_secded_hamming_72_64_enc_gpu_cov_tb (
  ...
  prim_secded_hamming_72_64_enc dut (
    .data_i,
    .data_o
  );
  ...
  function automatic logic [CodeWidth-1:0] encode_ref(input logic [DataWidth-1:0] data);
    ...
    enc[64] = ^(enc & 72'h00AB55555556AAAD5B);
    enc[65] = ^(enc & 72'h00CD9999999B33366D);
    enc[66] = ^(enc & 72'h00F1E1E1E1E3C3C78E);
    enc[67] = ^(enc & 72'h0001FE01FE03FC07F0);
    enc[68] = ^(enc & 72'h0001FFFE0003FFF800);
    enc[69] = ^(enc & 72'h0001FFFFFFFC000000);
    enc[70] = ^(enc & 72'h00FE00000000000000);
    enc[71] = ^(enc & 72'h7FFFFFFFFFFFFFFFFF);
    return enc;
  endfunction
...
endmodule : prim_secded_hamming_72_64_enc_gpu_cov_tb
