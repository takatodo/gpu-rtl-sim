...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_secded_hamming_76_68_enc.

module prim_secded_hamming_76_68_enc_gpu_cov_tb (
  ...
  logic [31:0] parity_bit68_count_q;
  logic [31:0] parity_bit69_count_q;
  logic [31:0] parity_bit70_count_q;
  logic [31:0] parity_bit71_count_q;
  logic [31:0] parity_bit72_count_q;
  logic [31:0] parity_bit73_count_q;
  logic [31:0] parity_bit74_count_q;
  logic [31:0] parity_bit75_count_q;
  ...
  prim_secded_hamming_76_68_enc dut (
    .data_i,
    .data_o
  );
  ...
  function automatic logic [DataWidth-1:0] mix_data(
    ...
    mixed = {state, prng_next(state ^ salt), prng_next(state + salt)} ^
            ...
            {prng_next(salt ^ 32'h7668_ecc1), prng_next(state),
             prng_next(state ^ 32'h68_76_0001)};
  ...
  function automatic logic [CodeWidth-1:0] encode_ref(input logic [DataWidth-1:0] data);
    ...
    enc[68] = ^(enc & 76'h00AAB55555556AAAD5B);
    enc[69] = ^(enc & 76'h00CCD9999999B33366D);
    enc[70] = ^(enc & 76'h000F1E1E1E1E3C3C78E);
    enc[71] = ^(enc & 76'h00F01FE01FE03FC07F0);
    enc[72] = ^(enc & 76'h00001FFFE0003FFF800);
    enc[73] = ^(enc & 76'h00001FFFFFFFC000000);
    enc[74] = ^(enc & 76'h00FFE00000000000000);
  ...
  assign parity_nonzero_w = |data_o[75:68];
  ...
  always_ff @(posedge clk_i) begin
    ...
    if (!rst_ni) begin
      ...
      drain_cycle_q <= 32'd0;
      rand_q <= cfg_seed_i ^ 32'h76_68_0001;
      data_i <= '0;
      last_data_q <= '0;
      last_data_o_q <= '0;
      ...
      parity_bit68_count_q <= 32'd0;
      parity_bit69_count_q <= 32'd0;
      parity_bit70_count_q <= 32'd0;
      parity_bit71_count_q <= 32'd0;
      parity_bit72_count_q <= 32'd0;
      parity_bit73_count_q <= 32'd0;
      parity_bit74_count_q <= 32'd0;
      parity_bit75_count_q <= 32'd0;
      signature_q <= cfg_seed_i ^ 32'h1e76_6801;
      ...
      signature_q <= {signature_q[24:0], signature_q[31:25]} ^
                     rand_q ^ data_i[31:0] ^ data_i[63:32] ^
                     {28'd0, data_i[67:64]} ^
      ...
      if (|data_i[22:0]) begin data_low_activity_count_q <= data_low_activity_count_q + 32'd1; seen_q[10] <= 1'b1; end
      if (|data_i[45:23]) begin data_mid_activity_count_q <= data_mid_activity_count_q + 32'd1; seen_q[11] <= 1'b1; end
      if (|data_i[67:46]) begin data_high_activity_count_q <= data_high_activity_count_q + 32'd1; seen_q[12] <= 1'b1; end
      if (data_o[68]) begin parity_bit68_count_q <= parity_bit68_count_q + 32'd1; seen_q[17] <= 1'b1; end
      if (data_o[69]) begin parity_bit69_count_q <= parity_bit69_count_q + 32'd1; seen_q[18] <= 1'b1; end
      if (data_o[70]) begin parity_bit70_count_q <= parity_bit70_count_q + 32'd1; seen_q[19] <= 1'b1; end
      if (data_o[71]) begin parity_bit71_count_q <= parity_bit71_count_q + 32'd1; seen_q[20] <= 1'b1; end
      if (data_o[72]) begin parity_bit72_count_q <= parity_bit72_count_q + 32'd1; seen_q[21] <= 1'b1; end
      if (data_o[73]) begin parity_bit73_count_q <= parity_bit73_count_q + 32'd1; seen_q[22] <= 1'b1; end
      if (data_o[74]) begin parity_bit74_count_q <= parity_bit74_count_q + 32'd1; seen_q[23] <= 1'b1; end
      if (data_o[75]) begin parity_bit75_count_q <= parity_bit75_count_q + 32'd1; seen_q[24] <= 1'b1; end
  ...
  assign real_toggle_subset_word11_o = parity_bit68_count_q ^ parity_bit69_count_q;
  assign real_toggle_subset_word12_o = parity_bit70_count_q ^ parity_bit71_count_q;
  assign real_toggle_subset_word13_o = parity_bit72_count_q ^ parity_bit73_count_q;
  assign real_toggle_subset_word14_o = parity_bit74_count_q ^ parity_bit75_count_q;
  assign real_toggle_subset_word15_o = (data_i[31:0] ^ last_data_q[31:0]) ^
                                       (data_i[63:32] ^ last_data_q[63:32]) ^
                                       ({28'd0, data_i[67:64]} ^
                                        {28'd0, last_data_q[67:64]});
  assign real_toggle_subset_word16_o = (data_o[31:0] ^ last_data_o_q[31:0]) ^
                                       (data_o[63:32] ^ last_data_o_q[63:32]) ^
                                       ({20'd0, data_o[75:64]} ^
                                        {20'd0, last_data_o_q[75:64]});
  assign real_toggle_subset_word17_o = {31'd0, done_o} ^ progress_signature_o;

  assign focused_wave_word0_o = data_i[31:0];
  assign focused_wave_word1_o = data_i[63:32] ^ {28'd0, data_i[67:64]};
  assign focused_wave_word2_o = data_o[31:0];
  assign focused_wave_word3_o = data_o[63:32];
  assign focused_wave_word4_o = {20'd0, data_o[75:64]};
  assign focused_wave_word5_o = {29'd0, output_nonzero_w, parity_nonzero_w,
                                 observed_match_w};
  ...
  assign oracle_semantic_family_acked_o = {
    parity_bit68_count_q[3:0],
    parity_bit69_count_q[3:0],
    parity_bit70_count_q[3:0],
    parity_bit71_count_q[3:0],
    parity_bit72_count_q[3:0],
    parity_bit73_count_q[3:0],
    parity_bit74_count_q[3:0],
    parity_bit75_count_q[3:0]
  };
  assign oracle_semantic_case_seen_o = data_i[31:0] ^ data_i[63:32] ^
                                       {28'd0, data_i[67:64]};
...
endmodule : prim_secded_hamming_76_68_enc_gpu_cov_tb
