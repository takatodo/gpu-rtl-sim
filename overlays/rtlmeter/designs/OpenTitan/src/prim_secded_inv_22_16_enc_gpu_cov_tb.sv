...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_secded_inv_22_16_enc.

module prim_secded_inv_22_16_enc_gpu_cov_tb (
  ...
  logic [31:0] parity_bit16_count_q;
  logic [31:0] parity_bit17_count_q;
  logic [31:0] parity_bit18_count_q;
  logic [31:0] parity_bit19_count_q;
  logic [31:0] parity_bit20_count_q;
  logic [31:0] parity_bit21_count_q;
  ...
  function automatic logic [CodeWidth-1:0] encode_ref(input logic [DataWidth-1:0] data);
    ...
    enc[16] = ^(enc & 22'h00496E);
    enc[17] = ^(enc & 22'h00F20B);
    enc[18] = ^(enc & 22'h008ED8);
    enc[19] = ^(enc & 22'h007714);
    enc[20] = ^(enc & 22'h00ACA5);
    enc[21] = ^(enc & 22'h0011F3);
    enc ^= 22'h2A0000;
    return enc;
  endfunction
  ...
  assign parity_nonzero_w = |data_o[21:16];
  ...
  always_ff @(posedge clk_i) begin
    ...
    if (!rst_ni) begin
      ...
      parity_bit16_count_q <= 32'd0;
      parity_bit17_count_q <= 32'd0;
      parity_bit18_count_q <= 32'd0;
      parity_bit19_count_q <= 32'd0;
      parity_bit20_count_q <= 32'd0;
      parity_bit21_count_q <= 32'd0;
      ...
      signature_q <= {signature_q[24:0], signature_q[31:25]} ^
                     rand_q ^ {16'd0, data_i} ^ {10'd0, data_o} ^
                     {26'd0, data_o[21:16]} ^
      ...
      if (|data_i[10:6]) begin data_mid_activity_count_q <= data_mid_activity_count_q + 32'd1; seen_q[11] <= 1'b1; end
      if (|data_i[15:11]) begin data_high_activity_count_q <= data_high_activity_count_q + 32'd1; seen_q[12] <= 1'b1; end
      if (data_o[16]) begin parity_bit16_count_q <= parity_bit16_count_q + 32'd1; seen_q[13] <= 1'b1; end
      if (data_o[17]) begin parity_bit17_count_q <= parity_bit17_count_q + 32'd1; seen_q[14] <= 1'b1; end
      if (data_o[18]) begin parity_bit18_count_q <= parity_bit18_count_q + 32'd1; seen_q[15] <= 1'b1; end
      if (data_o[19]) begin parity_bit19_count_q <= parity_bit19_count_q + 32'd1; seen_q[16] <= 1'b1; end
      if (data_o[20]) begin parity_bit20_count_q <= parity_bit20_count_q + 32'd1; seen_q[17] <= 1'b1; end
      if (data_o[21]) begin parity_bit21_count_q <= parity_bit21_count_q + 32'd1; seen_q[18] <= 1'b1; end
  ...
  assign real_toggle_subset_word11_o = parity_bit16_count_q ^ parity_bit17_count_q;
  assign real_toggle_subset_word12_o = parity_bit18_count_q ^ parity_bit19_count_q;
  assign real_toggle_subset_word13_o = parity_bit20_count_q ^ parity_bit21_count_q;
  assign real_toggle_subset_word14_o = parity_bit21_count_q;
  assign real_toggle_subset_word15_o = {16'd0, data_i} ^ {16'd0, last_data_q};
  assign real_toggle_subset_word16_o = {10'd0, data_o} ^ {10'd0, last_data_o_q};
  assign real_toggle_subset_word17_o = {31'd0, done_o} ^ progress_signature_o;

  assign focused_wave_word0_o = {16'd0, data_i};
  assign focused_wave_word1_o = {10'd0, data_o};
  assign focused_wave_word2_o = {26'd0, data_o[21:16]};
  ...
  assign oracle_semantic_family_acked_o = {
    parity_bit16_count_q[3:0],
    parity_bit17_count_q[3:0],
    parity_bit18_count_q[3:0],
    parity_bit19_count_q[3:0],
    parity_bit20_count_q[3:0],
    parity_bit21_count_q[3:0],
    8'd0
  };
  assign oracle_semantic_case_seen_o = {16'd0, data_i};
  assign oracle_semantic_case_acked_o = {10'd0, data_o};
...
endmodule : prim_secded_inv_22_16_enc_gpu_cov_tb
