...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_secded_inv_28_22_enc.

module prim_secded_inv_28_22_enc_gpu_cov_tb (
  ...
  localparam int unsigned DataWidth = 22;
  localparam int unsigned CodeWidth = 28;
  ...
  logic [31:0] parity_bit22_count_q;
  logic [31:0] parity_bit23_count_q;
  logic [31:0] parity_bit24_count_q;
  logic [31:0] parity_bit25_count_q;
  logic [31:0] parity_bit26_count_q;
  logic [31:0] parity_bit27_count_q;
  ...
  function automatic logic [CodeWidth-1:0] encode_ref(input logic [DataWidth-1:0] data);
    ...
    enc[22] = ^(enc & 28'h03003FF);
    enc[23] = ^(enc & 28'h010FC0F);
    enc[24] = ^(enc & 28'h0271C71);
    enc[25] = ^(enc & 28'h03B6592);
    enc[26] = ^(enc & 28'h03DAAA4);
    enc[27] = ^(enc & 28'h03ED348);
    enc ^= 28'hA800000;
    return enc;
  endfunction
  ...
  assign parity_nonzero_w = |data_o[27:22];
  ...
  always_ff @(posedge clk_i) begin
    ...
    if (!rst_ni) begin
      ...
      drain_cycle_q <= 32'd0;
      rand_q <= cfg_seed_i ^ 32'h28_22_0001;
      data_i <= '0;
      last_data_q <= '0;
      last_data_o_q <= '0;
      ...
      parity_bit22_count_q <= 32'd0;
      parity_bit23_count_q <= 32'd0;
      parity_bit24_count_q <= 32'd0;
      parity_bit25_count_q <= 32'd0;
      parity_bit26_count_q <= 32'd0;
      parity_bit27_count_q <= 32'd0;
      signature_q <= cfg_seed_i ^ 32'h1e28_2201;
      ...
      signature_q <= {signature_q[24:0], signature_q[31:25]} ^
                     rand_q ^ {10'd0, data_i} ^ {4'd0, data_o} ^
                     {26'd0, data_o[27:22]} ^
      ...
      if (|data_i[14:8]) begin data_mid_activity_count_q <= data_mid_activity_count_q + 32'd1; seen_q[11] <= 1'b1; end
      if (|data_i[21:15]) begin data_high_activity_count_q <= data_high_activity_count_q + 32'd1; seen_q[12] <= 1'b1; end
      if (data_o[22]) begin parity_bit22_count_q <= parity_bit22_count_q + 32'd1; seen_q[13] <= 1'b1; end
      if (data_o[23]) begin parity_bit23_count_q <= parity_bit23_count_q + 32'd1; seen_q[14] <= 1'b1; end
      if (data_o[24]) begin parity_bit24_count_q <= parity_bit24_count_q + 32'd1; seen_q[15] <= 1'b1; end
      if (data_o[25]) begin parity_bit25_count_q <= parity_bit25_count_q + 32'd1; seen_q[16] <= 1'b1; end
      if (data_o[26]) begin parity_bit26_count_q <= parity_bit26_count_q + 32'd1; seen_q[17] <= 1'b1; end
      if (data_o[27]) begin parity_bit27_count_q <= parity_bit27_count_q + 32'd1; seen_q[18] <= 1'b1; end
  ...
  assign real_toggle_subset_word11_o = parity_bit22_count_q ^ parity_bit23_count_q;
  assign real_toggle_subset_word12_o = parity_bit24_count_q ^ parity_bit25_count_q;
  assign real_toggle_subset_word13_o = parity_bit26_count_q ^ parity_bit27_count_q;
  assign real_toggle_subset_word14_o = parity_bit27_count_q;
  assign real_toggle_subset_word15_o = {10'd0, data_i} ^ {10'd0, last_data_q};
  assign real_toggle_subset_word16_o = {4'd0, data_o} ^ {4'd0, last_data_o_q};
  assign real_toggle_subset_word17_o = {31'd0, done_o} ^ progress_signature_o;

  assign focused_wave_word0_o = {10'd0, data_i};
  assign focused_wave_word1_o = {4'd0, data_o};
  assign focused_wave_word2_o = {26'd0, data_o[27:22]};
  ...
  assign oracle_semantic_family_acked_o = {
    parity_bit22_count_q[3:0],
    parity_bit23_count_q[3:0],
    parity_bit24_count_q[3:0],
    parity_bit25_count_q[3:0],
    parity_bit26_count_q[3:0],
    parity_bit27_count_q[3:0],
    8'd0
  };
  assign oracle_semantic_case_seen_o = {10'd0, data_i};
  assign oracle_semantic_case_acked_o = {4'd0, data_o};
...
endmodule : prim_secded_inv_28_22_enc_gpu_cov_tb
