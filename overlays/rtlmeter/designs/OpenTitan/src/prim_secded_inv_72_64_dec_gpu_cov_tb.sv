...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_secded_inv_72_64_dec.

module prim_secded_inv_72_64_dec_gpu_cov_tb (
  ...
  localparam logic [CodeWidth-1:0] InversionMask = 72'hAA0000000000000000;
  ...
  function automatic logic [7:0] syndrome_ref(input logic [CodeWidth-1:0] code);
    logic [7:0] syn;
    syn[0] = ^((code ^ InversionMask) & 72'h01B9000000001FFFFF);
    syn[1] = ^((code ^ InversionMask) & 72'h025E00000FFFE0003F);
    syn[2] = ^((code ^ InversionMask) & 72'h0467003FF003E007C1);
    syn[3] = ^((code ^ InversionMask) & 72'h08CD0FC0F03C207842);
    syn[4] = ^((code ^ InversionMask) & 72'h10B671C711C4438884);
    syn[5] = ^((code ^ InversionMask) & 72'h20B5B65926488C9108);
    syn[6] = ^((code ^ InversionMask) & 72'h40CBDAAA4A91152210);
    syn[7] = ^((code ^ InversionMask) & 72'h807AED348D221A4420);
    return syn;
  endfunction
  ...
  function automatic logic [DataWidth-1:0] decode_data_ref(input logic [CodeWidth-1:0] code);
    ...
    dec[0] = (syn == 8'h7) ^ code[0];
    dec[1] = (syn == 8'hb) ^ code[1];
    dec[2] = (syn == 8'h13) ^ code[2];
    dec[3] = (syn == 8'h23) ^ code[3];
    dec[4] = (syn == 8'h43) ^ code[4];
    dec[5] = (syn == 8'h83) ^ code[5];
    dec[6] = (syn == 8'hd) ^ code[6];
    dec[7] = (syn == 8'h15) ^ code[7];
    dec[8] = (syn == 8'h25) ^ code[8];
    dec[9] = (syn == 8'h45) ^ code[9];
    dec[10] = (syn == 8'h85) ^ code[10];
    dec[11] = (syn == 8'h19) ^ code[11];
    dec[12] = (syn == 8'h29) ^ code[12];
    dec[13] = (syn == 8'h49) ^ code[13];
    dec[14] = (syn == 8'h89) ^ code[14];
    dec[15] = (syn == 8'h31) ^ code[15];
    dec[16] = (syn == 8'h51) ^ code[16];
    dec[17] = (syn == 8'h91) ^ code[17];
    dec[18] = (syn == 8'h61) ^ code[18];
    dec[19] = (syn == 8'ha1) ^ code[19];
    dec[20] = (syn == 8'hc1) ^ code[20];
    dec[21] = (syn == 8'he) ^ code[21];
    dec[22] = (syn == 8'h16) ^ code[22];
    dec[23] = (syn == 8'h26) ^ code[23];
    dec[24] = (syn == 8'h46) ^ code[24];
    dec[25] = (syn == 8'h86) ^ code[25];
    dec[26] = (syn == 8'h1a) ^ code[26];
    dec[27] = (syn == 8'h2a) ^ code[27];
    dec[28] = (syn == 8'h4a) ^ code[28];
    dec[29] = (syn == 8'h8a) ^ code[29];
    dec[30] = (syn == 8'h32) ^ code[30];
    dec[31] = (syn == 8'h52) ^ code[31];
    dec[32] = (syn == 8'h92) ^ code[32];
    dec[33] = (syn == 8'h62) ^ code[33];
    dec[34] = (syn == 8'ha2) ^ code[34];
    dec[35] = (syn == 8'hc2) ^ code[35];
    dec[36] = (syn == 8'h1c) ^ code[36];
    dec[37] = (syn == 8'h2c) ^ code[37];
    dec[38] = (syn == 8'h4c) ^ code[38];
    dec[39] = (syn == 8'h8c) ^ code[39];
    dec[40] = (syn == 8'h34) ^ code[40];
    dec[41] = (syn == 8'h54) ^ code[41];
    dec[42] = (syn == 8'h94) ^ code[42];
    dec[43] = (syn == 8'h64) ^ code[43];
    dec[44] = (syn == 8'ha4) ^ code[44];
    dec[45] = (syn == 8'hc4) ^ code[45];
    dec[46] = (syn == 8'h38) ^ code[46];
    dec[47] = (syn == 8'h58) ^ code[47];
    dec[48] = (syn == 8'h98) ^ code[48];
    dec[49] = (syn == 8'h68) ^ code[49];
    dec[50] = (syn == 8'ha8) ^ code[50];
    dec[51] = (syn == 8'hc8) ^ code[51];
    dec[52] = (syn == 8'h70) ^ code[52];
    dec[53] = (syn == 8'hb0) ^ code[53];
    dec[54] = (syn == 8'hd0) ^ code[54];
    dec[55] = (syn == 8'he0) ^ code[55];
    dec[56] = (syn == 8'h6d) ^ code[56];
    dec[57] = (syn == 8'hd6) ^ code[57];
    dec[58] = (syn == 8'h3e) ^ code[58];
    dec[59] = (syn == 8'hcb) ^ code[59];
    dec[60] = (syn == 8'hb3) ^ code[60];
    dec[61] = (syn == 8'hb5) ^ code[61];
    dec[62] = (syn == 8'hce) ^ code[62];
    dec[63] = (syn == 8'h79) ^ code[63];
    return dec;
  endfunction
  ...
  function automatic logic [CodeWidth-1:0] inject_error(
    ...
    unique case (selector[3:0])
      ...
      4'h7: begin out[3] = ~code[3]; out[71] = ~code[71]; end
  ...
  always_ff @(posedge clk_i) begin
    ...
    if (!rst_ni) begin
      ...
      drain_cycle_q <= 32'd0;
      rand_q <= cfg_seed_i ^ 32'h72_64_00a5;
      data_i <= '0;
      last_data_q <= '0;
      last_data_o_q <= '0;
      ...
      signature_q <= cfg_seed_i ^ 32'h1e72_64a5;
      ...
      if (|data_i[71:18]) begin data_high_activity_count_q <= data_high_activity_count_q + 32'd1; seen_q[12] <= 1'b1; end
...
endmodule : prim_secded_inv_72_64_dec_gpu_cov_tb
