...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_secded_inv_72_64_enc.

module prim_secded_inv_72_64_enc_gpu_cov_tb (
  ...
  localparam int unsigned CodeWidth = 72;
  ...
  logic [31:0] parity_bit64_count_q;
  logic [31:0] parity_bit65_count_q;
  logic [31:0] parity_bit66_count_q;
  logic [31:0] parity_bit67_count_q;
  ...
  function automatic logic [CodeWidth-1:0] encode_ref(input logic [DataWidth-1:0] data);
    ...
    enc[64] = ^(enc & 72'h00B9000000001FFFFF);
    enc[65] = ^(enc & 72'h005E00000FFFE0003F);
    enc[66] = ^(enc & 72'h0067003FF003E007C1);
    enc[67] = ^(enc & 72'h00CD0FC0F03C207842);
    enc[68] = ^(enc & 72'h00B671C711C4438884);
    enc[69] = ^(enc & 72'h00B5B65926488C9108);
    enc[70] = ^(enc & 72'h00CBDAAA4A91152210);
    enc[71] = ^(enc & 72'h007AED348D221A4420);
    return enc ^ 72'hAA0000000000000000;
  endfunction
  ...
  assign parity_nonzero_w = |data_o[71:64];
  ...
  always_ff @(posedge clk_i) begin
    ...
    if (!rst_ni) begin
      ...
      drain_cycle_q <= 32'd0;
      rand_q <= cfg_seed_i ^ 32'h72_64_0001;
      data_i <= '0;
      last_data_q <= '0;
      last_data_o_q <= '0;
      ...
      parity_bit64_count_q <= 32'd0;
      parity_bit65_count_q <= 32'd0;
      parity_bit66_count_q <= 32'd0;
      parity_bit67_count_q <= 32'd0;
      parity_bit68_count_q <= 32'd0;
      parity_bit69_count_q <= 32'd0;
      parity_bit70_count_q <= 32'd0;
      parity_bit71_count_q <= 32'd0;
      signature_q <= cfg_seed_i ^ 32'h1e72_6401;
      ...
      if (|data_i[21:0]) begin data_low_activity_count_q <= data_low_activity_count_q + 32'd1; seen_q[10] <= 1'b1; end
      if (|data_i[42:22]) begin data_mid_activity_count_q <= data_mid_activity_count_q + 32'd1; seen_q[11] <= 1'b1; end
      if (|data_i[63:43]) begin data_high_activity_count_q <= data_high_activity_count_q + 32'd1; seen_q[12] <= 1'b1; end
      if (data_o[64]) begin parity_bit64_count_q <= parity_bit64_count_q + 32'd1; seen_q[13] <= 1'b1; end
      if (data_o[65]) begin parity_bit65_count_q <= parity_bit65_count_q + 32'd1; seen_q[14] <= 1'b1; end
      if (data_o[66]) begin parity_bit66_count_q <= parity_bit66_count_q + 32'd1; seen_q[15] <= 1'b1; end
      if (data_o[67]) begin parity_bit67_count_q <= parity_bit67_count_q + 32'd1; seen_q[16] <= 1'b1; end
  ...
  assign real_toggle_subset_word11_o = parity_bit64_count_q ^ parity_bit65_count_q;
  assign real_toggle_subset_word12_o = parity_bit66_count_q ^ parity_bit67_count_q;
  assign real_toggle_subset_word13_o = parity_bit68_count_q ^ parity_bit69_count_q;
  assign real_toggle_subset_word14_o = parity_bit70_count_q ^ parity_bit71_count_q;
  ...
  assign oracle_semantic_family_acked_o = {
    parity_bit64_count_q[3:0],
    parity_bit65_count_q[3:0],
    parity_bit66_count_q[3:0],
    parity_bit67_count_q[3:0],
...
endmodule : prim_secded_inv_72_64_enc_gpu_cov_tb
