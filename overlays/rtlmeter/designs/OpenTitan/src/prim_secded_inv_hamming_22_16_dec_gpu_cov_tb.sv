...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_secded_inv_hamming_22_16_dec.

module prim_secded_inv_hamming_22_16_dec_gpu_cov_tb (
  ...
  prim_secded_inv_hamming_22_16_dec dut (
    .data_i,
    .data_o,
    .syndrome_o,
    .err_o
  ...
  function automatic logic [5:0] syndrome_ref(input logic [CodeWidth-1:0] code);
    ...
    syn[0] = ^(unmasked & 22'h01AD5B);
    syn[1] = ^(unmasked & 22'h02366D);
    syn[2] = ^(unmasked & 22'h04C78E);
    syn[3] = ^(unmasked & 22'h0807F0);
    syn[4] = ^(unmasked & 22'h10F800);
    syn[5] = ^(unmasked & 22'h3FFFFF);
    return syn;
  endfunction
  ...
  always_ff @(posedge clk_i) begin
    ...
    if (!rst_ni) begin
      ...
      drain_cycle_q <= 32'd0;
      rand_q <= cfg_seed_i ^ 32'h22_16_0a5a;
      data_i <= '0;
      last_data_q <= '0;
      last_data_o_q <= '0;
      ...
      signature_q <= cfg_seed_i ^ 32'h1e22_1a5a;
...
endmodule : prim_secded_inv_hamming_22_16_dec_gpu_cov_tb
