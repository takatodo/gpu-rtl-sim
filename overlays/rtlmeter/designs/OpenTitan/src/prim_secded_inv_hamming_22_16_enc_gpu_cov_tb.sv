...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_secded_inv_hamming_22_16_enc.

module prim_secded_inv_hamming_22_16_enc_gpu_cov_tb (
  ...
  prim_secded_inv_hamming_22_16_enc dut (
    .data_i,
    .data_o
  );
...
endmodule : prim_secded_inv_hamming_22_16_enc_gpu_cov_tb
