...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_secded_inv_hamming_39_32_enc.

module prim_secded_inv_hamming_39_32_enc_gpu_cov_tb (
  ...
  localparam int unsigned CodeWidth = 39;
  ...
  logic [31:0] parity_bit32_count_q;
  logic [31:0] parity_bit33_count_q;
  logic [31:0] parity_bit34_count_q;
  logic [31:0] parity_bit35_count_q;
  logic [31:0] parity_bit36_count_q;
  logic [31:0] parity_bit37_count_q;
  logic [31:0] parity_bit38_count_q;
  ...
  prim_secded_inv_hamming_39_32_enc dut (
    .data_i,
    .data_o
  );
  ...
  function automatic logic [CodeWidth-1:0] encode_ref(input logic [DataWidth-1:0] data);
    ...
    enc[32] = ^(enc & 39'h0056AAAD5B);
    enc[33] = ^(enc & 39'h009B33366D);
    enc[34] = ^(enc & 39'h00E3C3C78E);
    enc[35] = ^(enc & 39'h0003FC07F0);
    enc[36] = ^(enc & 39'h0003FFF800);
    enc[37] = ^(enc & 39'h00FC000000);
    enc[38] = ^(enc & 39'h3FFFFFFFFF);
    return enc ^ 39'h2A00000000;
  endfunction
  ...
  assign parity_nonzero_w = |data_o[38:32];
  ...
  always_ff @(posedge clk_i) begin
    ...
    if (!rst_ni) begin
      ...
      drain_cycle_q <= 32'd0;
      rand_q <= cfg_seed_i ^ 32'h39_32_0002;
      data_i <= '0;
      last_data_q <= '0;
      last_data_o_q <= '0;
      ...
      parity_bit32_count_q <= 32'd0;
      parity_bit33_count_q <= 32'd0;
      parity_bit34_count_q <= 32'd0;
      parity_bit35_count_q <= 32'd0;
      parity_bit36_count_q <= 32'd0;
      parity_bit37_count_q <= 32'd0;
      parity_bit38_count_q <= 32'd0;
      signature_q <= cfg_seed_i ^ 32'h1e39_3202;
      ...
      if (|data_i[10:0]) begin data_low_activity_count_q <= data_low_activity_count_q + 32'd1; seen_q[10] <= 1'b1; end
      if (|data_i[21:11]) begin data_mid_activity_count_q <= data_mid_activity_count_q + 32'd1; seen_q[11] <= 1'b1; end
      if (|data_i[31:22]) begin data_high_activity_count_q <= data_high_activity_count_q + 32'd1; seen_q[12] <= 1'b1; end
      if (data_o[32]) begin parity_bit32_count_q <= parity_bit32_count_q + 32'd1; seen_q[13] <= 1'b1; end
      if (data_o[33]) begin parity_bit33_count_q <= parity_bit33_count_q + 32'd1; seen_q[14] <= 1'b1; end
      if (data_o[34]) begin parity_bit34_count_q <= parity_bit34_count_q + 32'd1; seen_q[15] <= 1'b1; end
      if (data_o[35]) begin parity_bit35_count_q <= parity_bit35_count_q + 32'd1; seen_q[16] <= 1'b1; end
      if (data_o[36]) begin parity_bit36_count_q <= parity_bit36_count_q + 32'd1; seen_q[17] <= 1'b1; end
      if (data_o[37]) begin parity_bit37_count_q <= parity_bit37_count_q + 32'd1; seen_q[18] <= 1'b1; end
      if (data_o[38]) begin parity_bit38_count_q <= parity_bit38_count_q + 32'd1; seen_q[19] <= 1'b1; end
  ...
  assign real_toggle_subset_word11_o = parity_bit32_count_q ^ parity_bit33_count_q;
  assign real_toggle_subset_word12_o = parity_bit34_count_q ^ parity_bit35_count_q;
  assign real_toggle_subset_word13_o = parity_bit36_count_q ^ parity_bit37_count_q;
  assign real_toggle_subset_word14_o = parity_bit38_count_q;
  assign real_toggle_subset_word15_o = data_i ^ last_data_q;
  ...
  assign focused_wave_word0_o = data_i;
  assign focused_wave_word1_o = data_o[31:0];
  assign focused_wave_word2_o = {25'd0, data_o[38:32]};
  assign focused_wave_word3_o = {29'd0, output_nonzero_w, parity_nonzero_w,
                                 observed_match_w};
  assign focused_wave_word4_o = input_nonzero_count_q ^ input_zero_count_q;
  assign focused_wave_word5_o = output_nonzero_count_q ^ parity_nonzero_count_q;
  ...
  assign oracle_semantic_family_acked_o = {
    parity_bit32_count_q[3:0],
    parity_bit33_count_q[3:0],
    parity_bit34_count_q[3:0],
    parity_bit35_count_q[3:0],
    parity_bit36_count_q[3:0],
    parity_bit37_count_q[3:0],
    parity_bit38_count_q[3:0],
    4'd0
  };
  assign oracle_semantic_case_seen_o = data_i;
  assign oracle_semantic_case_acked_o = data_o[31:0] ^ {25'd0, data_o[38:32]};
...
endmodule : prim_secded_inv_hamming_39_32_enc_gpu_cov_tb
