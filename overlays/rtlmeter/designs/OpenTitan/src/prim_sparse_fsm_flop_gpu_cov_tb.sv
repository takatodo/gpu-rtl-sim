...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_sparse_fsm_flop.

module prim_sparse_fsm_flop_gpu_cov_tb (
  ...
  always_ff @(posedge clk_i) begin
    ...
    if (!rst_ni) begin
      ...
      drain_cycle_q <= 32'd0;
      rand_q <= cfg_seed_i ^ 32'h5f5d_f10f;
      ...
      signature_q <= cfg_seed_i ^ 32'h5f5d_1020;
...
endmodule : prim_sparse_fsm_flop_gpu_cov_tb
