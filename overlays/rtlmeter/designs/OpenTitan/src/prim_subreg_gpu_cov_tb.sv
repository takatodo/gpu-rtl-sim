...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_subreg.

module prim_subreg_gpu_cov_tb (
  ...
  logic [Width-1:0] d_i;
  logic [Width-1:0] q_o;
  logic [Width-1:0] ds_o;
  logic [Width-1:0] qs_o;
  logic [Width-1:0] out_o;
  logic [Width-1:0] q_model_q;
  ...
  assign expected_out_w = q_model_q;
  assign next_expected_out_w = expected_wr_en_w ? expected_wr_data_w : q_model_q;
  ...
  assign focused_wave_word2_o = {24'd0, q_o};
  assign focused_wave_word3_o = {25'd0, qe_o, de_i, we_i, expected_wr_en_w,
  ...
  assign oracle_semantic_case_seen_o = {14'd0, qe_o, de_i, in0_i, in1_i};
  assign oracle_semantic_case_acked_o = {8'd0, q_o, ds_o, qs_o};
...
endmodule : prim_subreg_gpu_cov_tb
