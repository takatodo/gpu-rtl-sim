...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_xilinx_clock_buf.

module prim_xilinx_clock_buf_gpu_cov_tb (
  ...
  always_ff @(posedge clk_i) begin
    ...
    if (!rst_ni) begin
      ...
      drain_cycle_q <= 32'd0;
      rand_q <= cfg_seed_i ^ 32'hc10c_1b01;
      dut_clk_i <= 1'b0;
      last_dut_clk_q <= 1'b0;
      last_clk_o_q <= 1'b0;
      ...
      signature_q <= cfg_seed_i ^ 32'hb0ff_1c01;
...
endmodule : prim_xilinx_clock_buf_gpu_cov_tb
