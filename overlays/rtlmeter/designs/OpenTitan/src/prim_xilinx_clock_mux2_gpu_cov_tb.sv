...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_xilinx_clock_mux2.

module prim_xilinx_clock_mux2_gpu_cov_tb (
...
endmodule : prim_xilinx_clock_mux2_gpu_cov_tb
