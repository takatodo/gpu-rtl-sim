...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_xilinx_flop_en.

module prim_xilinx_flop_en_gpu_cov_tb (
...
endmodule : prim_xilinx_flop_en_gpu_cov_tb
