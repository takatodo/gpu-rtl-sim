...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_xilinx_pad_attr.

module prim_xilinx_pad_attr_gpu_cov_tb
...
endmodule : prim_xilinx_pad_attr_gpu_cov_tb
