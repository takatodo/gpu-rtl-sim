...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_xilinx_ultrascale_and2.

module prim_xilinx_ultrascale_and2_gpu_cov_tb (
  ...
  always_ff @(posedge clk_i) begin
    ...
    if (!rst_ni) begin
      ...
      drain_cycle_q <= 32'd0;
      rand_q <= cfg_seed_i ^ 32'h2a2d_0001;
      in0_i <= '0;
      in1_i <= '0;
      last_out_q <= '0;
      last_in0_q <= '0;
      ...
      signature_q <= cfg_seed_i ^ 32'h51e0_aa2d;
...
endmodule : prim_xilinx_ultrascale_and2_gpu_cov_tb
