...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_xilinx_ultrascale_buf.

module prim_xilinx_ultrascale_buf_gpu_cov_tb (
...
endmodule : prim_xilinx_ultrascale_buf_gpu_cov_tb
