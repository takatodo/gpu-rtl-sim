...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_xilinx_ultrascale_clock_inv.

module prim_xilinx_ultrascale_clock_inv_gpu_cov_tb (
...
endmodule : prim_xilinx_ultrascale_clock_inv_gpu_cov_tb
