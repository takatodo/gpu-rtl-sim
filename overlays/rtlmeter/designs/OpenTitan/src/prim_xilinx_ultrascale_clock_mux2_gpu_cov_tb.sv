...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_xilinx_ultrascale_clock_mux2.

module prim_xilinx_ultrascale_clock_mux2_gpu_cov_tb (
  ...
  always_ff @(posedge clk_i) begin
    ...
    if (!rst_ni) begin
      ...
      drain_cycle_q <= 32'd0;
      rand_q <= cfg_seed_i ^ 32'hc10c_1e01;
      clk0_dut_i <= 1'b0;
      clk1_dut_i <= 1'b1;
      sel_i <= 1'b0;
      last_clk0_q <= 1'b0;
...
endmodule : prim_xilinx_ultrascale_clock_mux2_gpu_cov_tb
