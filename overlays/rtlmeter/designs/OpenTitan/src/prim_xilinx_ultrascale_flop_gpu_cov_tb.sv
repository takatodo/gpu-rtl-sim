...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_xilinx_ultrascale_flop.

module prim_xilinx_ultrascale_flop_gpu_cov_tb (
  ...
  always_ff @(posedge clk_i) begin
    ...
    if (!rst_ni) begin
      ...
      drain_cycle_q <= 32'd0;
      rand_q <= cfg_seed_i ^ 32'hf10f_0f1a;
      ...
      signature_q <= cfg_seed_i ^ 32'h3c3c_1020;
      ...
      if (post_reset_seen_q && q_o == last_d_q) begin
  ...
  assign real_toggle_subset_word2_o = {24'd0, last_d_q};
  ...
  assign real_toggle_subset_word6_o = q_change_count_q;
  assign real_toggle_subset_word7_o = q_follow_count_q;
  assign real_toggle_subset_word8_o = q_mismatch_count_q;
  ...
  assign real_toggle_subset_word14_o = {24'd0, last_q_q};
  ...
  assign focused_wave_word2_o = {24'd0, last_d_q};
  ...
  assign oracle_semantic_case_acked_o = {16'd0, last_d_q, last_q_q};
...
endmodule : prim_xilinx_ultrascale_flop_gpu_cov_tb
