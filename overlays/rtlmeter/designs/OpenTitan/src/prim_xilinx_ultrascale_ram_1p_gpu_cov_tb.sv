...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_xilinx_ultrascale_ram_1p.

module prim_xilinx_ultrascale_ram_1p_gpu_cov_tb
...
endmodule : prim_xilinx_ultrascale_ram_1p_gpu_cov_tb
