...
//
// Minimal GPU-toggle-ready standalone coverage target for prim_xilinx_ultrascale_xor2.

module prim_xilinx_ultrascale_xor2_gpu_cov_tb (
...
endmodule : prim_xilinx_ultrascale_xor2_gpu_cov_tb
