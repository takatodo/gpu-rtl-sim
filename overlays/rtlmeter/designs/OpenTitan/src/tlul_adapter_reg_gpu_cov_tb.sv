...
//
// Minimal deterministic coverage harness for tlul_adapter_reg.

module tlul_adapter_reg_gpu_cov_tb (
  ...
  assign real_toggle_subset_word10_o = {24'd0, addr_w};
  assign real_toggle_subset_word11_o = wdata_w;
  assign real_toggle_subset_word12_o = rdata_w;
  ...
  assign focused_wave_word2_o = {16'd0, tl_i.a_valid, tl_o.a_ready, tl_o.d_valid, tl_i.d_ready,
                                 we_w, re_w, busy_w, error_w, addr_w};
