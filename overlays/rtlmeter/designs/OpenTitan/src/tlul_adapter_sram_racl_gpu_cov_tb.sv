...
//
// Minimal deterministic coverage harness for tlul_adapter_sram_racl.

module tlul_adapter_sram_racl_gpu_cov_tb (
  ...
  assign progress_signature_o = oracle_req_signature_o ^ last_rsp_digest_q ^ sram_signature_q ^
                                last_sram_digest_q ^ racl_role_signature_q ^
                                racl_policy_signature_q ^ {31'd0, done_o};
  ...
  assign real_toggle_subset_word8_o = racl_error_count_q;
  assign real_toggle_subset_word9_o = racl_allowed_count_q;
  assign real_toggle_subset_word10_o = racl_denied_count_q;
  assign real_toggle_subset_word11_o = racl_role_signature_q ^ racl_policy_signature_q;
  assign real_toggle_subset_word12_o = host_stall_count_q;
  assign real_toggle_subset_word13_o = error_rsp_count_q;
  assign real_toggle_subset_word14_o = addr_signature_q ^ data_signature_q;
  ...
  assign focused_wave_word2_o = {9'd0, racl_error_w, racl_error_log_w.racl_role,
                                 tl_i.a_user.rsvd[0], sram_req_type_w,
                                 sram_req_w, sram_gnt_w, sram_we_w,
