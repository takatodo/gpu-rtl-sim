...
class CommitSplitCleanupGateTest(unittest.TestCase):
    ...
    def test_completion_gate_closes_index_rewrite_and_selects_parser_boundary(self) -> None:
        ...
        self.assertEqual(
            ...
            "config/scaling_gates/review_verilator_native_option_parser_direct_command_path_native_invocation_direct_launch_handoff_sidecar_launcher_invocation_fixture_implementation_gate.json",
        )
        self.assertEqual(selection["repository_cleanup"]["records_scaling_gate_json_count"], 924)
    ...
    def test_public_pack_manifest_includes_definition_gate(self) -> None:
        ...
        self.assertIn(
            "records/scaling_gates/define_verilator_native_option_parser_sidecar_plan_resolution_status_hardening_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_sidecar_plan_resolution_status_hardening_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/implement_verilator_native_option_parser_sidecar_plan_resolution_status_hardening_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_sidecar_plan_resolution_status_hardening_implementation_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/define_verilator_native_option_parser_sidecar_plan_resolution_handoff_contract_boundary_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_sidecar_plan_resolution_handoff_contract_boundary_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/implement_verilator_native_option_parser_sidecar_plan_resolution_handoff_contract_fixture_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_sidecar_plan_resolution_handoff_contract_fixture_implementation_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/define_verilator_native_option_parser_sidecar_plan_resolution_handoff_contract_operator_plan_boundary_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_sidecar_plan_resolution_handoff_contract_operator_plan_boundary_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/implement_verilator_native_option_parser_sidecar_plan_resolution_handoff_contract_operator_plan_fixture_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_sidecar_plan_resolution_handoff_contract_operator_plan_fixture_implementation_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/define_verilator_native_option_parser_sidecar_plan_resolution_handoff_contract_operator_plan_fixture_hardening_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_sidecar_plan_resolution_handoff_contract_operator_plan_fixture_hardening_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/implement_verilator_native_option_parser_sidecar_plan_resolution_handoff_contract_operator_plan_fixture_hardening_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_sidecar_plan_resolution_handoff_contract_operator_plan_fixture_hardening_implementation_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/define_verilator_native_option_parser_sidecar_plan_resolution_handoff_contract_operator_plan_execution_boundary_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
        ...
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_sidecar_plan_resolution_handoff_contract_operator_plan_sidecar_execution_run_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/define_verilator_native_option_parser_direct_command_path_boundary_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_direct_command_path_boundary_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/define_verilator_native_option_parser_direct_command_path_fixture_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_direct_command_path_fixture_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/implement_verilator_native_option_parser_direct_command_path_fixture_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_direct_command_path_fixture_implementation_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/define_verilator_native_option_parser_direct_command_path_fixture_payload_validation_hardening_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_direct_command_path_fixture_payload_validation_hardening_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/implement_verilator_native_option_parser_direct_command_path_fixture_payload_validation_hardening_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_direct_command_path_fixture_payload_validation_hardening_implementation_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/define_verilator_native_option_parser_direct_command_path_sidecar_stage_plan_materialization_boundary_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_direct_command_path_sidecar_stage_plan_materialization_boundary_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/implement_verilator_native_option_parser_direct_command_path_sidecar_stage_plan_materialization_fixture_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_direct_command_path_sidecar_stage_plan_materialization_fixture_implementation_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/define_verilator_native_option_parser_direct_command_path_sidecar_stage_plan_execution_boundary_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/review_verilator_native_option_parser_direct_command_path_sidecar_stage_plan_execution_boundary_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
            "records/scaling_gates/run_verilator_native_option_parser_direct_command_path_sidecar_stage_plan_execution_gate.json",
            PUBLIC_PACK_ARCHIVE_PATHS,
        )
        self.assertIn(
