...
class FullItaMhaAndLargerPagedKvNextGateTest(unittest.TestCase):
    ...
    def test_public_benchmark_pack_externalization_readiness_is_documented(self) -> None:
        ...
        for token in (
            ...
            "Review the generated-config usability path together.",
            ...
            "python3 src/tools/gen_hybrid_config.py --target PULP_ITA.demo_cov --top-module demo_cov_tb --overlay overlays/demo/src/demo_cov_tb.sv --dry-run",
