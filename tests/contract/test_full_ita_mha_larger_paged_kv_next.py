...
class FullItaMhaAndLargerPagedKvNextGateTest(unittest.TestCase):
    ...
    def test_public_benchmark_pack_externalization_readiness_is_documented(self) -> None:
        ...
        for token in (
            ...
            "Review `public_pack_archive_ready` together with the public-pack support files it references.",
            ...
            "generated `reports/` snapshots may be included in a review bundle as evidence",
