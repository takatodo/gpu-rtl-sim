...
class ReducedActiveSurfaceContractTest(ResidentRuntimeContractHelpers, unittest.TestCase):
    ...
    def test_selection_is_compact_current_state(self) -> None:
        ...
        self.assertEqual(
            ...
            "config/scaling_gates/implement_verilator_native_option_parser_direct_command_path_native_invocation_verilator_process_launcher_bridge_fixture_gate.json",
        )
