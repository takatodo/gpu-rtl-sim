...
class ReducedActiveSurfaceContractTest(ResidentRuntimeContractHelpers, unittest.TestCase):
    def test_makefile_operator_shortcuts_documents_and_runs_status(self) -> None:
        ...
        self.assertIn(
            "review_verilator_native_option_parser_direct_command_path_native_invocation_verilator_process_launcher_bridge_boundary_gate",
            completed.stdout,
        )
    ...
    def test_selection_is_compact_current_state(self) -> None:
        ...
        self.assertEqual(
            ...
            "config/scaling_gates/define_verilator_native_option_parser_direct_command_path_native_invocation_verilator_process_launcher_bridge_boundary_gate.json",
        )
