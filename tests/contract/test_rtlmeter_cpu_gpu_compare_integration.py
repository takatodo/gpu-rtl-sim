...
class RtlmeterCpuGpuCompareIntegrationTest(HybridCliTestCase):
    ...
    def test_runner_backed_observables_only_success_has_no_reviewed_proxy_metadata_observed(self) -> None:
        ...
        self.assertIn("sidecar_execute_proxy_installed_or_source_patch_by_wrapper_branch", evidence["blocking_context"])
        ...
        self.assertIn("sidecar_execute_proxy_installed_or_source_patch_by_wrapper_branch", execution_evidence["blocking_context"])
