...
TRACKED_TOOL_ROOTS = (
    *PUBLIC_PACK_TOOL_ROOTS,
    ...
    "verilator_native_sidecar_make_driver",
    "verilator_use_gpu_first_path",
    "verilator_use_gpu_wrapper_runtime",
    "rtlmeter_cpu_gpu_compare_integration",
    "rtlmeter_cpu_gpu_compare_policy",
    "rtlmeter_overlay_audit",
    ...
    "gategpt_entry_sliced_cubin_chain",
    "gategpt_stage112_store_source_summary",
    "gategpt_testbench_probe",
    "gpu_sidecar_eligibility_policy",
    "gpu_sidecar_eligibility_policy_cli",
    "heavy_rtl_candidate_matrix",
    "hybrid_template_repeat_median",
    "llvm_rtl_gpu_suitability",
    "llvm_rtl_gpu_suitability_cli",
    "rtlmeter_cpu_parallel_baseline",
    "rtlmeter_gpu_favorable_conditions_audit",
    "rtlmeter_hybrid_advantage",
    "rtlmeter_hybrid_measurement_difficulty",
    "rtlmeter_non_veer_hybrid_measurement_summary",
    "rtlmeter_non_veer_hybrid_next_queue",
    "rtlmeter_non_veer_usefulness_candidates",
    "rtlmeter_nvdla_hot_ss_measurement_plan",
    "rtlmeter_nvdla_hot_ss_plan_dry_run",
    "rtlmeter_nvdla_hot_ss_repeat_summary",
    "rtlmeter_veer_el2_cpu_snapshot",
    "rtlmeter_veer_el2_timing",
    "rtlmeter_veer_family_cpu_reference_summary",
    "rtlmeter_veer_family_surface_audit",
    "rtlmeter_vortex_binary_input_summary",
    "rtlmeter_vortex_cpu_reference_summary",
    "rtlmeter_vortex_cuda_memory_transport_preflight",
    "rtlmeter_vortex_cuda_runtime_sequence_preflight",
    "rtlmeter_vortex_dcr_schedule",
    "rtlmeter_vortex_device_buffer_materialize",
    "rtlmeter_vortex_dpi_memory_bridge_review",
    "rtlmeter_vortex_first_gate_readiness",
    "rtlmeter_vortex_generated_dpi_memory_helper_patch",
    "rtlmeter_vortex_generated_lowered_tb_invocation_smoke",
    "rtlmeter_vortex_gpu_memory_model_plan",
    "rtlmeter_vortex_hybrid_candidate_summary",
    "rtlmeter_vortex_kernel_artifact_build_attempt",
    "rtlmeter_vortex_kernel_callback_preflight",
    "rtlmeter_vortex_lowered_tb_invocation_smoke",
    "rtlmeter_vortex_lowered_tb_memory_helper_integration_smoke",
    "rtlmeter_vortex_materialized_runtime_invocation_smoke",
    "rtlmeter_vortex_memory_model_reference",
    "rtlmeter_vortex_observable_authority_audit",
    "rtlmeter_vortex_ptx_entry_slice",
    "rtlmeter_vortex_ptx_module_load_diagnostic",
    "rtlmeter_vortex_real_kernel_artifact_preflight",
    "rtlmeter_vortex_runtime_invocation_plan",
    "rtlmeter_vortex_sidecar_context",
    "rtlmeter_vortex_source_closure",
    "rtlmeter_vortex_timing",
    "rtlmeter_vortex_veer_hybrid_measurement_matrix",
    "rtlmeter_vsim_main_vortex_materialized_runtime_args_probe_patch",
    "rtlmeter_vsim_main_vortex_probe_marker_strip",
    "rtlmeter_vsim_main_vortex_real_cuda_materialized_runtime_patch",
    "rtlmeter_vsim_main_vortex_real_cuda_materialized_runtime_smoke",
    "rtlmeter_vsim_main_vortex_runtime_bridge_stub_patch",
    "rtlmeter_vsim_main_vortex_runtime_invocation_probe_patch",
    "rtlmeter_vsim_main_vortex_runtime_marker_patch",
    "rtlmeter_vsim_main_vortex_runtime_stub_patch",
    "scientific_circt_batched_reduction",
    "scientific_circt_bridge_spec",
    "scientific_circt_broader_runtime_entrypoint",
    "scientific_circt_dense_matmul_tile",
    "scientific_circt_dense_matmul_tile_gpu_timing",
    "scientific_circt_evidence_audit",
    "scientific_circt_gategpt_microgpt_compare",
    "scientific_circt_gpu_candidate_plan",
    "scientific_circt_gpu_selection_policy",
    "scientific_circt_hls_attention_head_variant",
    "scientific_circt_hls_mlp_block_variants",
    "scientific_circt_hybrid_advantage",
    "scientific_circt_hybrid_dispatch_matrix",
    "scientific_circt_hybrid_protocol",
    "scientific_circt_microgpt_attention_head",
    "scientific_circt_microgpt_block_slice",
    "scientific_circt_microgpt_inference_slice",
    "scientific_circt_microgpt_ir_partition_probe",
    "scientific_circt_microgpt_math_block",
    "scientific_circt_microgpt_mlp_slice",
    "scientific_circt_runtime_entrypoint",
    "scientific_circt_runtime_handoff_abi",
    "scientific_circt_runtime_handoff_adapter",
    "scientific_circt_softmax_exp_pipeline",
    "scientific_circt_source_variant_bridge_emit",
    "scientific_circt_source_variant_metadata",
    "scientific_circt_source_variant_runtime_dispatcher",
    "scientific_circt_source_variant_runtime_handoff",
    "scientific_circt_stencil_2d_tile",
    "scientific_circt_verilator_callsite_entrypoint",
    "veer_eh_sidecar_executable",
)
