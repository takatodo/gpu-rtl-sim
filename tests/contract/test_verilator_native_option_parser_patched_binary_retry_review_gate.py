...
class VerilatorNativeOptionParserPatchedBinaryRetryReviewGateTest(unittest.TestCase):
    def test_selection_points_at_first_scoped_execution_boundary_review_after_definition(self) -> None:
        ...
        self.assertEqual(selection["current_priority"], REVIEW_DIRECT_LAUNCH_HANDOFF_SIDECAR_LAUNCHER_INVOCATION_FIXTURE_IMPLEMENTATION_GATE_NAME)
        self.assertEqual(selection["current_priority_source_artifact"], f"config/scaling_gates/{IMPLEMENT_DIRECT_LAUNCH_HANDOFF_SIDECAR_LAUNCHER_INVOCATION_FIXTURE_GATE_NAME}.json")
